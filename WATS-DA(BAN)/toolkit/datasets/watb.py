...
class WATBVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(WATBVideo, self).__init__(name, root, video_dir,
...
class WATBDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(WATBDataset, self).__init__(name, dataset_root)
        with open(os.path.join(dataset_root, 'WATB.json'), 'r') as f:
        ...
        for video in pbar:
            ...
            self.videos[video] = WATBVideo(video,
                                          dataset_root,
