...
from toolkit.datasets import UAVDataset, UAVDARK70Dataset, NATDataset, NAT_LDataset,NUT_LDataset,WATBDataset
from toolkit.evaluation import OPEBenchmark


parser = argparse.ArgumentParser(description='tracking evaluation')
parser.add_argument('--tracker_path', '-p', type=str, default='/media/w/719A549756118C56/HGG/WATS-DA(GAT)/results_ddam_240309', # './results', './hp_search_results/checkpoint_e17'
                    help='tracker result path')
parser.add_argument('--dataset', '-d', type=str, default='WATB',  # UAVDark70, NAT_L #NAT #NUT_L
                    help='dataset name')
...
def main():
    ...
    #                         '../testing_dataset'))
    root = '/media/w/719A549756118C56/datasets/WATB/WATB/' #'/mnt/sdg/Test_dataset/' #/mnt/sdb/Test_dataset/NAT2021_test' #/mnt/sdb/Test_dataset/NUT-L_folder
