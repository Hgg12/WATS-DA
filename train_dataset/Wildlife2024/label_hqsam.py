...
# from hqsam.segment_anything import SamAutomaticMaskGenerator, sam_model_registry
# import cv2
...
#     "--checkpoint",
#     type=str,
#     default='hqsam/snapshot/sam_hq_vit_h.pth', # pth path 
#     # required=True,
...
#     "--output",
#     type=str,
#     default='tracker/BAN/train_dataset/WATB400/outputs',
#     # required=True,
#     help="The output path.",
# )

# parser.add_argument("--device", type=str, default="cuda", help="The device to run generation on.")
# parser.add_argument("--dataset_root", type=str, default="/media/w/719A549756118C56/datasets/WATB400/", help="The dataset to process.")
...
# def run_sequence(sub_dir, sam, args, num_gpu=1):
...
#     for sub_dir_idx, sub_dir in enumerate(os.listdir(args.dataset_root)):
...
#             sub_dir:bbox_list
#         }
#         save_file = os.path.join(args.output, str(sub_dir_idx)) + ".json"
#         with open(save_file, 'a') as file:
#             json.dump(bbox_print, file, indent=4, sort_keys=True)
#             file.write('\n')
#             # file.flush()  # 刷新缓冲区，立即写入文件
#         # print("Complete %s" % sub_dir)
...
parser.add_argument(
    "--output",
    type=str,
    default='/media/w/719A549756118C56/HGG/SAM-DA-main/tracker/BAN/train_dataset/WATB2024_4',
    # required=True,
    help="The output path.",
)

parser.add_argument("--device", type=str, default="cuda", help="The device to run generation on.")
parser.add_argument("--dataset_root", type=str, default="/media/w/719A549756118C56/datasets/WATB2024_4/", help="The dataset to process.")
