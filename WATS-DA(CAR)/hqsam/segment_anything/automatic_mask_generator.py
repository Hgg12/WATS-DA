...
class SamAutomaticMaskGenerator:
    ...
    def generate_bbox(self, image: np.ndarray):
        """
        Generates bbox for the given image.
        ...
        curr_anns = []
        for idx in range(len(mask_data["boxes"])):
            ann = box_xyxy_to_xywh(mask_data["boxes"][idx]).tolist()
            curr_anns.append(ann)
