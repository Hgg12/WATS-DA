...
def main(instanc_size=511, num_threads=12):
    dataDir = '/media/w/719A549756118C56/datasets/WATB2024_4/'
    crop_path = 'tracker/BAN/train_dataset/WATB2024_4/crop{:d}'.format(instanc_size)
    if not isdir(crop_path): mkdir(crop_path)

    jsonFile = 'tracker/BAN/train_dataset/WATB2024_4/result/list.json'
    ...
    for dictionary in dictionaries:
        ...
        annFile = 'tracker/BAN/train_dataset/WATB2024_4/result/annotations/{}.json'.format(dataType)
        if isfile(annFile):
            continue
