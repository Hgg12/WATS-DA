...
def resnet18(output_layers=None, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(resnet.ResNet18_Weights.url))
    return model
...
def resnet50(output_layers=None, pretrained=False, **kwargs):
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3], output_layers, **kwargs)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(resnet.ResNet50_Weights.url))
    return model
...
def resnet34(output_layers=None, pretrained=False, dilation_factor=1):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(resnet.ResNet34_Weights.url))
    return model
