...
import importlib
import inspect
import ar.ltr.admin.settings as ws_settings
...
def load_network(network_dir=None, checkpoint=None, constructor_fun_name=None, constructor_module=None, **kwargs):
    ...
    missing, unexcept = net.load_state_dict(checkpoint_dict['net'], strict = False)
...
def _setup_legacy_env():
    importlib.import_module('ar.ltr')
    sys.modules['dlframework'] = sys.modules['ar.ltr']
    sys.modules['dlframework.common'] = sys.modules['ar.ltr']
    importlib.import_module('ar.ltr.admin')
    sys.modules['dlframework.common.utils'] = sys.modules['ar.ltr.admin']
    for m in ('model_constructor', 'stats', 'settings', 'local'):
        importlib.import_module('ar.ltr.admin.' + m)
        sys.modules['dlframework.common.utils.' + m] = sys.modules['ar.ltr.admin.' + m]
